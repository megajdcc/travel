   ...
   <b-container fluid class="px-0 mx-0">
      ...
      <b-card no-body class="mb-0">
               ...
               <b-col md="6">
                  <div class="d-flex align-items-center justify-content-end">
                     ...
                     <b-input-group size="sm">
                        ...
                        <template #append>
                           <b-button variant="dark" :to="{name:'create.categoria'}" v-if="$can('write','categorias')">
         ...
         <b-table ref="refTable" :items="fetchData" responsive :fields="tableColumns" primary-key="id"
            ...
            <template #cell(contenido)="{item}">
               <span class="text-nowrap">{{ item.contenidos.length }}</span>
            </template>
            ...
            <template #cell(actions)="{item}">
               ...
               <b-button-group size="sm">
                  ...
                  <b-button :to="{name:'edit.categoria',params:{id:item.id}}" v-if="$can('update','categorias')" variant="primary" title="Editar Categoría">
                     <feather-icon icon="edit" />
                  </b-button>

                  <b-button @click="eliminar(item.id)" variant="danger" title="Eliminar categoría"  v-if="$can('delete','categorias')" >
