<template>
  ...
  >
    ...
    >
    <span :class="`fas ${item.icon} `" v-if="item.fontAwesome" class="mr-1"></span>
    
    <feather-icon size="14" :icon="item.icon || 'CircleIcon'" v-else />
...
import VerticalNavMenuHeader from '../vertical-nav-menu-header/index.vue'
