<template>
  ...
  <div class="horizontal-layout" :class="[layoutClasses]" :data-col="isNavMenuHidden ? '1-column' : null"
    ...
    <b-navbar :style="{
      ...
      :class="{ 'fixed-top': app.currentBreakPoint !== 'xl'}">
    ...
    <div class="horizontal-menu-wrapper">
      ...
      <div v-if="!isNavMenuHidden"
        class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-light navbar-shadow menu-border d-none d-xl-block" style="margin-top:1.3rem"
